    ...
    <v-layout row wrap>
      <v-flex xs12 sm6 offset-3>
        <v-form v-model="isFormValid" lazy-validation ref="form" @submit.prevent="handleAddPost">
          ...
          <v-layout row>
            <v-flex xs12>
              <v-text-field :rules="titleRules" v-model="title" label="Post Title" type="text" required autocomplete="off" counter="20" maxLength="20">
              </v-text-field>
            </v-flex>
          </v-layout>
          ...
          <v-layout row>
            <v-flex xs12>
              <v-text-field :rules="imageRules" v-model="imageUrl" label="Image URL" type="text" required autocomplete="off">
              </v-text-field>
            </v-flex>
          </v-layout>
          ...
          <v-layout row>
            <v-flex xs12>
              <v-textarea :rules="descRules" v-model="description" label="Description" type="text" required autocomplete="off" counter="200" maxLength="200">
              </v-textarea>
            </v-flex>
          </v-layout>
  ...
  data(){
    return {
      ...
      descRules: [
        ...
        description => !!description.length < 200 || 'Title must have less than 200 characters'
      ],
      categoriesRules: [
